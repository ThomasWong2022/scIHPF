...
for dataset in datasets:
    ...
    for l in hyper_parameter_space:
        ...
        model = IHPF.run_trials(Xlist,no_cell_types,max_iter=500, model_kwargs = {'dataset_ratio':l})
        ...
        adata.write('../Data/{}_new.h5ad'.format(dataset))
